    ...
    <div class="col-md-11">
        ...
        ?>
                <div class="alert alert-info">
                    <strong>এন্ট্রি সরানো হয়েছে </strong>
                    <a href="newsAdmin"> এন্ট্রি সরানো হয়েছে</a>
                </div>
            <?php
            } else if ($test == false) {
            ?>
                <div class="alert alert-warning">
                    <strong>রেকর্ড মুছে ফেলার ত্রুটি হয়েছে!</strong>
                    <a href="newsAdmin"> এন্ট্রি সরানো হয়েছে </a>
                </div>
            <?php
            }
                    ...
                    <tr>
                        <td colspan="2">
                            <button type="submit" class="btn btn-primary" name="save">
                                <span class="glyphicon glyphicon-remove"></span> ডিলিট
                            </button>
