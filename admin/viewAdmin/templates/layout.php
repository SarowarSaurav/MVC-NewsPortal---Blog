...
<body>
    <div class="container">
                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        ...
                        echo '<ul class="nav nav-pills pull-right">
                                <li role="button">
                                    ' . $_SESSION["name"] . '<a href="logout" style="display: inline;">Log off <i class="fa fa-sign-out"></i></a>
                                </li>
                            </ul>';
                        ...
                        if (isset($_SESSION["status"]) && $_SESSION["status"] == "admin") {
                            ...
                            echo '<h4>y You have no rights!</h4>';
                        }
                        ?>
        ...
        <footer class="footer">
            <p>&copy; 2022 CSE470 Project<i class="fa fa-child"></i></p>
        </footer>
    </div>
